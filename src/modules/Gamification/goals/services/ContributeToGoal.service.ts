...
// //         const newCurrentAmount = userGoal.currentAmount + amount;

// //         const progressPercent =
// //             userGoal.targetAmount > 0
// //                 ? Math.min(
// //                     100,
// //                     Math.round((newCurrentAmount / userGoal.targetAmount) * 100),
// //                 )
// //                 : 0;
...
// //         // --- cria registro de CashFlow atrelado à meta ---
// //         const flowDate = date ?? new Date();

// //         const goalTitle =
// //             updatedGoal.customTitle ||
// //             updatedGoal.goal?.title ||
// //             "Meta financeira";

// //         const defaultLabel = `Depósito na meta: ${goalTitle}`;
// //         const flowLabel =
// //             label && label.trim().length > 0 ? label : defaultLabel;

// //         const dimension = updatedGoal.goal?.dimension; // FinancialDimension | undefined

// //         const defaultCategory =
// //             category && category.trim().length > 0
// //                 ? category
// //                 : dimension
// //                     ? `META_${dimension}` // ex: META_DESENROLA
// //                     : "META_OUTROS";
...
// //             operation: CashFlowOperation.TRANSFER,
// //             amount,
// //             userGoalId: updatedGoal.id,
// //             recipient: recipient ?? null,
// //         });

// //         // --- aplica recompensas de gamificação, se concluiu agora ---
// //         let xpPoints = 0;
// //         let xpCoins = 0;
...
// //             xpCoins += coinsFromTemplate + coinsFromUserGoal;
...
// //         // 👉 Aqui é o ponto ideal para, no futuro, plugar uma lógica de atualização
// //         // do FinancialProfile da dimensão (DESENROLA / ORGANIZA / RESERVA / INVESTE),
// //         // usando updatedGoal.goal?.dimension e o delta de progresso (% ou valor).
// //         // Mantive desacoplado para não quebrar o módulo de Onboarding.
...
// // src/modules/Gamification/goals/services/ContributeToGoal.service.ts
// import { inject, injectable } from "tsyringe";
// import {
//     CashFlowOperation,
//     type CashFlow,
...
export class ContributeToGoalService {
    constructor(
        ...
        // 👇 injeta explicitamente pelo tipo da classe
